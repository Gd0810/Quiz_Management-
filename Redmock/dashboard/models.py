...
class Company(models.Model):
    ...
    allow_copy_paste_block = models.BooleanField(default=False)
    allow_right_click_disable = models.BooleanField(default=False)
    allow_multi_user = models.BooleanField(default=True)
    ...
    multi_user_enabled = models.BooleanField(default=False)
